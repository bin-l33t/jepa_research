...
test_jepa.py: jepa_core.py
	...
	@$(COMPILER) test_jepa.py "Read jepa_core.py. Write a unit test script. 1. Test SIGRegLoss on Gaussian input. 2. Test SIGRegLoss on Uniform input. 3. Check VectorFlow shapes."
